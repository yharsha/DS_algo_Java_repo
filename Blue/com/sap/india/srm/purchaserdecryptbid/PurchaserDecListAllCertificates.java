...
//This class lists all the certificates present in the token or keystore...
public class PurchaserDecListAllCertificates {
	public String[][] listOfCertificates;
	public ArrayList<X509Certificate> certificateobjects;
	public int certificateSize ; 
	public PurchaserDecListAllCertificates() {
