...
import com.sap.india.srm.purchaseruploadcertificates.PurchaserValidateCertificate;

//This class will list all the certificates available in microsoft keystore....
 
public class VendorListAllCertificates extends MainApplet {
	public String[][] listOfCertificates;
	public ArrayList<X509Certificate> certificateobjects;
	public int certificateSize ; 
	public VendorListAllCertificates() {
	...
	//this method fetches all the certificates from the microsoft keystore and return them to the listing table on the applet...
		...
		try{
			...
			for(X509Certificate cert : this.certificateobjects){
                ...
                if(keyusage != null) {
                	...
                	else if(!keyusage[0] && (keyusage[2] || keyusage[3])){
